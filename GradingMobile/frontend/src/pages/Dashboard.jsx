...
import { Layers, Activity, AlertTriangle, ArrowRight, Scissors } from 'lucide-react';
...
const Dashboard = () => {
    ...
    const activities = [
        ...
        {
            id: 'truck-study',
            title: 'Estudio de Camión',
            description: 'Inspección y registro de calidad de camiones',
            icon: Activity,
            color: 'from-blue-500 to-indigo-500',
        ...
        },
        {
            ...
            title: 'Estudio de Astilla',
            description: 'Control de calidad de astilla siniestrada',
            icon: AlertTriangle,
            color: 'from-orange-500 to-red-500',
            path: '/process/siniestrada'
        }
    ];
