        ...
        <div className="p-6 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-slate-400 mt-1 text-sm md:text-base">Administra accesos y permisos del personal</p>
                </div>
                <div className="flex flex-wrap gap-3 w-full md:w-auto">
                    <Link to="/admin/config" className="flex-1 md:flex-none">
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="w-full md:w-auto px-4 py-3 bg-slate-800 border border-slate-700 text-white rounded-xl shadow-lg flex items-center justify-center gap-2 font-semibold hover:bg-slate-700 text-sm"
                        >
                    ...
                    {canAdd && (
                        <motion.button
                            ...
                            whileTap={{ scale: 0.95 }}
                            onClick={() => openModal()}
                            className="flex-1 md:flex-none w-full md:w-auto px-4 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl shadow-lg flex items-center justify-center gap-2 font-semibold text-sm"
                        >
