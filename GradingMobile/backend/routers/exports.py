...
def export_inspection_details_csv(
    ...
    query = db.query(models.InspectionResult).join(models.Inspection)
    ...
    headers = ["ID Inspección", "Fecha", "Tipo", "Turno", "Supervisor", "Producto", "Lote", "Grado", "Defecto", "Piezas", "Responsable"]
