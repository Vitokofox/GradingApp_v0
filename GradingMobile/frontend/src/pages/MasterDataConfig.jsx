...
import {
    ...
    getMarkets, createMarket, deleteMarket
} from '../api';
import {
    Settings, Plus, Trash2, Upload, FileText, Check, AlertCircle, Database,
    ChevronRight, Layers, LayoutList, GitMerge
} from 'lucide-react';
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            <div className="bg-slate-900/50 p-4 rounded-lg border border-slate-800">
                                ...
                                <button className="mt-4 text-xs text-purple-400 hover:text-purple-300 flex items-center gap-1">
